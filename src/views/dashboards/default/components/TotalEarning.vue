  ...
  <v-card elevation="0" class="bg-secondary overflow-hidden bubble-shape bubble-secondary-shape">
    <v-card-text>
      ...
      <h2 class="text-h1 font-weight-medium">
        R$500.00 <a href="#"><CircleArrowUpRightIcon stroke-width="1.5" width="28" class="text-white" /> </a>
      </h2>
      <span class="text-subtitle-1 text-medium-emphasis text-white">Total Pagamento Mês</span>
    </v-card-text>
  </v-card>
</template>
